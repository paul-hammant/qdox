...
public abstract class APITestCase extends TestCase {
   ...
   public static void assertApiEquals(File expected, File actual)
      ...
      builder.addSource(expected);
      builder.addSource(actual);
      JavaSource expectedClass = builder.getSources()[0];
      JavaSource actualClass = builder.getSources()[1];
    ...
    * @param actual    the actual source
    */
   private static void assertApiEquals(
      JavaSource expected,
      JavaSource actual) {
      ...
      assertEquals(
         "Number of classes should be equal",
         expectedClasses.size(),
         actualClasses.size());

      for (int i = 0; i < expectedClasses.size(); i++) {
         assertClassesEqual(
            (JavaClass) expectedClasses.get(i),
    ...
    * @param actual
    */
   private static void assertClassesEqual(
      JavaClass expected,
      JavaClass actual) {
      assertEquals(
         "Package names should be equal",
         expected.getPackage(),
         actual.getPackage());
      assertModifiersEquals(
         "Class modifiers should be equal",
         expected,
         actual);
      assertEquals(
         "Class names should be equal",
         expected.getName(),
         actual.getName());
   ...
   private static void assertFieldEquals(
      ...
      assertEquals(
         message.toString() + "Field types should be equal",
         expected.getType(),
         actual.getType());
      assertEquals(
         message.toString() + "Field names should be equal",
         expected.getName(),
         actual.getName());
      assertModifiersEquals(
         message.toString() + "Field modifiers should be equal",
         expected,
         actual);
   }
   ...
   private static void assertFieldsEqual(
      ...
      assertEquals(
         message.toString() + "Number of fields should be equal",
         expectedFields.size(),
         actualFields.size());

      for (int i = 0; i < expectedFields.size(); i++) {
         assertFieldEquals(
            (JavaField) expectedFields.get(i),
    ...
    * comparison is still right.</p>
    */
   private static void assertInnerClassesEquals(
      JavaClass expected,
      JavaClass actual) {
      ...
      assertEquals(
         message.toString() + "Number of inner classes should be equal",
         expectedInnerClasses.size(),
         actualInnerClasses.size());

      for (int i = 0; i < expectedInnerClasses.size(); i++) {
         assertClassesEqual(
            (JavaClass) expectedInnerClasses.get(i),
   ...
   private static void assertInterfacesEqual(
      ...
      assertEquals(
         message.toString() + "Number of implemented interface should be equal",
         expectedImplements.size(),
         actualImplements.size());

      for (int i = 0; i < expectedImplements.size(); i++) {
         assertEquals(
            "Implemented interface should be equal",
   ...
   private static void assertMethodsEqual(
      ...
      assertEquals(
         message.toString() + "Number of methods should be equal",
         expectedMethods.size(),
         actualMethods.size());

      for (int i = 0; i < expectedMethods.size(); i++) {
         assertEquals(
            "Method should be equal",
    ...
    * comparison is still right.</p>
    */
   private static void assertModifiersEquals(
      String msg,
   ...
   private static void assertNotDir(File expected, File actual) {
      if (expected.isDirectory())
         fail(
            expected.getAbsolutePath() + " - should not have been a directory");
